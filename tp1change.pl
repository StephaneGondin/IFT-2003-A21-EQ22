...
etat_final():-nl,write('Arret du jeux').
...
choixdeminmax(C1,C2,C3,C4,C5,C6,C7,ColonneFinale):-
                               ...
                               nl,nl,write('Heuristie Min gagnante:  '),write(ValeurHeuristiqueMin),nl,write(ColoneFinaleMin),
                               heuristique(C1,C2,C3,C4,C5,C6,C7,ValeurHeuristiqueMax,'J',ColoneFinaleMax),!,
                               nl,nl,write('Heuristie Max gagnante:  '),write(ValeurHeuristiqueMax),nl,write(ColoneFinaleMax),
